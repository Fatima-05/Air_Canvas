...
class ArcPalette:
    ...
    def draw(self, img, hover_pt):
        ...
        for i, color in enumerate(self.colors):
            ...
            thickness = Config.ARC_THICKNESS + (12 if i == hover_index else 0)
            cv2.ellipse(
                img, (cx, cy),
...
def main():
    ...
    print("Air Canvas Activated. Press 'q' to quit.")
    print("Move your index finger + pinch with thumb to draw!")
    ...
    while True:
        ...
        if points:
            ...
            elif dist < Config.PINCH_THRESHOLD and smooth_y > 180:
                is_drawing = True
